  ...
  <section class="banner" id="index">
    <div class="contenmenulogo">
      <div class="menu pull-left">
          <ul>
            <a class="marca select" href="#index"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;INICIO</a>
            <a class="marca" href="#nosotros">NOSOTROS</a>
            <a class="marca" href="#productos">PRODUCTOS</a>
            <a class="marca" href="#contacto">CONTACTO</a>
          </ul>
      </div>
    ...
    <div class="boton" >
      <a href="#contacto"><button type="button" class="btn btn-success btn-lg">Contáctanos</button></a>
    </div>
  </section>
  <br><br>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 new-diseno">
            ...
            Nuestros productos son elaborados tradicionalmente con materias primas de primera calidad y dentro de los estándares modernos de higiene; así garantizando el mejor sabor de nuestras botanas, lo que los ha llevado a ser la botana preferida del mercado. <br><br>
            ...
            <div class="container">
                <div class="row">
                    <div class="about_our_company" style="margin-bottom: 20px;">
                        <h1 style="color:#fff;">Contáctanos</h1>
